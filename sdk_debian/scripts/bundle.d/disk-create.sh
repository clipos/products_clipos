...
ebegin "Creating ${IMAGE_FILE} as ${IMAGE_TYPE} ${IMAGE_SIZE}..."
...
einfo "Getting blockdev-getsz: OK"
...
einfo "Creating disk and partitions..."
guestfish --rw <<_EOF_
add-drive ${IMAGE_FILE} label:main
...
_EOF_
einfo "Creating disk and partitions: OK"

einfo "Creating vfat on EFI & LVM..."
guestfish --rw <<_EOF_
add-drive ${IMAGE_FILE} label:main
...
_EOF_
einfo "Creating vfat on EFI & LVM: OK"
